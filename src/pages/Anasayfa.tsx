...
export const Anasayfa: React.FC = () => {
  ...
  const [istatistikler, setIstatistikler] = useState({
    ...
    yillikHedefUretim: 0 // Yıllık hedef üretim değeri
  });
    ...
    const veriGetir = async () => {
      ...
      try {
        ...
        setIstatistikler({
          ...
          yillikUretim,
          toplamCO2Tasarrufu,
          yillikHedefUretim // Yıllık hedef üretim değeri
        });
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100 border-none shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="mt-1 bg-green-200 rounded-full h-1.5">
                <div 
                  ...
                  style={{ width: `${istatistikler.yillikHedefUretim > 0 ? (istatistikler.yillikUretim / istatistikler.yillikHedefUretim) * 100 : 0}%` }}
                ></div>
              </div>
            </div>
          </div>
        ...
        <Card className="bg-gradient-to-br from-amber-50 to-amber-100 border-none shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-2">
                <span className="text-xs text-amber-700">Son Bakım: 7 gün önce</span>
                <span className="text-xs text-amber-700">Sonraki: 23 gün sonra</span>
              </div>
        ...
        <Card className="bg-gradient-to-br from-red-50 to-red-100 border-none shadow-sm hover:shadow-md transition-all duration-300">
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-2">
                <span className="text-xs text-red-700">Acil Sipariş: 3 ürün</span>
                <span className="text-xs text-red-700">Stok Takibi</span>
              </div>
